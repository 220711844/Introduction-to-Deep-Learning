...
model_path = r"D:\Kuliah\semester 5\Pembelajaran Mesin dan Mendalam\Introduction to Deep Learning (Praktek)\best_model_tf.h5"
...
try:
    if os.path.exists(model_path):
        ...
        st.title("Fashion MNIST Image Classifier 1844")  
